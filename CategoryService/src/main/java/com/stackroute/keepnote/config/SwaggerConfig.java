...
public class SwaggerConfig {
	 private static final String API_NAME     = "Category Service API";
	...
	private ApiInfo apiMetaInfo() {
		return new ApiInfo(API_NAME, "Category", "1.0", "https://stackbooks-ust.stackroute.in/",
				"Stackroute Admin", "Category 1.0", "https://www.apache.org/licenses/LICENSE-2.0");
	}
