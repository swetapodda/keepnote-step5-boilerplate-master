...
1. Clone the base boilerplate in the folder **assignment-solution-step5** of your local machine
    ...
    `git clone https://gitlab-ibm.stackroute.in/stack_java_keep_v2/KeepNote-Step5-Boilerplate.git assignment-solution-step5`
...
5. Add your new repository reference as remote
     ...
     `git remote add origin https://gitlab-ibm.stackroute.in/{{yourusername}}/assignment-solution-step5`
