...
public class SwaggerConfig {
	 private static final String API_NAME     = "User_Auth Service API";
	...
	private ApiInfo apiMetaInfo() {
		return new ApiInfo(API_NAME, "User_Auth", "1.0", "https://stackbooks-ust.stackroute.in/",
				"Stackroute Admin", "User_Auth 1.0", "https://www.apache.org/licenses/LICENSE-2.0");
	}
