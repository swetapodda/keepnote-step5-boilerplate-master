...
public class SwaggerConfig {
	 private static final String API_NAME     = "Note Service API";
	...
	private ApiInfo apiMetaInfo() {
		return new ApiInfo(API_NAME, "Note", "1.0", "https://stackbooks-ust.stackroute.in/",
				"Stackroute Admin", "Note 1.0", "https://www.apache.org/licenses/LICENSE-2.0");
	}
